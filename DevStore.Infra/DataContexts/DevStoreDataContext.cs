...
namespace DevStore.Infra.DataContexts
{
    public class DevStoreDataContext : DbContext
    {
        ...
        {
            //Database.SetInitializer<DevStoreDataContext>(new DevStoreDataContextInitializar());
    ...
    public class DevStoreDataContextInitializar : DropCreateDatabaseIfModelChanges<DevStoreDataContext>
    {
